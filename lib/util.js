...
module.exports.simplify = function (str) {
	return str.replace(/\W/g, "").toLowerCase();
};

// Strip leading zeros and normalize capitalization of string.
...
// Calculate the distance (haversine) between two sets of coordinates.
